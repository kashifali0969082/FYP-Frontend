...
const MessageComponent = ({ message, selectedModelInfo, onOpenToolMessage, onLoadToolResponse }) => {
...
export const ToolPanel = forwardRef(({
  ...
  const sendChatMessage = async (content, autoGenerated = false, highlightedText) => {
  ...
  const handleSendMessage = async (messageContent, autoGenerated = false, highlightedTextOverride) => {
